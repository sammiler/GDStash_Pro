...
/*  41 */     ItemIDItemCombination combo = new ItemIDItemCombination(this);
/*     */     
/*  43 */     return combo;
/*     */   }
/*     */ 
...
/*  57 */       command = command + ", " + "GD_ITEM_SKILLS" + " ISB, " + "GD_ITEM_SKILL_LEVEL" + " ISBL";
/*     */     }
/*     */     
/*  60 */     if (getCriteria().isSkillModifierUsed()) {
/*  61 */       command = command + ", " + "GD_ITEM_SKILLMODIFIER" + " ISM";
/*     */     }
/*  63 */     if (statFilled) {
/*  64 */       command = command + ", " + "GD_ITEM_STAT" + " IST";
/*     */     }
/*     */     
/*  67 */     command = command + " WHERE ";
/*     */     
/*  69 */     if (getCriteria().isSkillBonusUsed()) {
/*  70 */       command = command + "I.ITEM_ID = ISB.ITEM_ID AND I.ITEM_ID = ISBL.ITEM_ID AND ISB.TYPE = ISBL.TYPE AND ISB.INDEX = ISBL.INDEX AND ";
/*     */     }
/*     */     
/*  73 */     if (getCriteria().isSkillModifierUsed()) {
/*  74 */       command = command + "I.ITEM_ID = ISM.ITEM_ID AND ";
/*     */     }
/*  76 */     if (statFilled) {
/*  77 */       command = command + "I.ITEM_ID = IST.ITEM_ID AND ";
/*     */     }
/*     */     
...
/* 148 */     ItemIDItemCombination combo = new ItemIDItemCombination(criteria);
/*     */     
/* 150 */     return getItemIDs(combo, soulbound, schc, isHardcore, charName);
/*     */   }
/*     */   
/*     */   public static List<String> getItemIDs(ItemIDItemCombination combo, CriteriaCombination.Soulbound soulbound, CriteriaCombination.SC_HC schc, boolean isHardcore, String charName) {
...
/* Location:              C:\Users\sammiler\Downloads\GDStash_v174\GDStash.jar!\org\gdstash\db\criteria\ItemIDItemCombination.class
