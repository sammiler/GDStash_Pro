...
/*     */ 
/*     */ 
/*     */ public class StashIDItemSetCombination
/*     */   extends AbstractItemCombination
/*     */ {
/*     */   public StashIDItemSetCombination() {}
/*     */   
/*     */   public StashIDItemSetCombination(StashIDItemSetCombination combo) {
/*  33 */     super(combo);
/*     */   }
/*     */   
/*     */   public StashIDItemSetCombination(SelectionCriteria criteria) {
/*  37 */     super(criteria);
/*     */   }
/*     */ 
/*     */   
/*     */   public StashIDItemSetCombination clone() {
/*  42 */     StashIDItemSetCombination combo = new StashIDItemSetCombination(this);
/*     */     
/*  44 */     return combo;
/*     */   }
/*     */ 
...
/*  58 */       command = command + ", " + "GD_ITEMSET_SKILLS" + " ISB, " + "GD_ITEMSET_SKILL_LEVEL" + " ISBL";
/*     */     }
/*     */     
/*  61 */     if (getCriteria().isSkillModifierUsed()) {
/*  62 */       command = command + ", " + "GD_ITEMSET_SKILLMODIFIER" + " ISM";
/*     */     }
/*  64 */     if (statFilled) {
/*  65 */       command = command + ", " + "GD_ITEMSET_STAT" + " IST";
/*     */     }
/*     */     
/*  68 */     command = command + " WHERE ";
/*     */     
/*  70 */     if (getCriteria().isSkillBonusUsed()) {
/*  71 */       command = command + "S.SET_ID = ISB.ITEMSET_ID AND S.SET_ID = ISBL.ITEMSET_ID AND ISB.TYPE = ISBL.TYPE AND ISB.INDEX = ISBL.INDEX AND ";
/*     */     }
/*     */     
/*  74 */     if (getCriteria().isSkillModifierUsed()) {
/*  75 */       command = command + "S.SET_ID = ISM.ITEMSET_ID AND ";
/*     */     }
/*  77 */     if (statFilled) {
/*  78 */       command = command + "S.SET_ID = IST.ITEMSET_ID AND ";
/*     */     }
/*     */     
...
/* 360 */     StashIDItemSetCombination combo = new StashIDItemSetCombination(criteria);
/*     */     
/* 362 */     return getStashIDs(combo, soulbound, schc, isHardcore, charName);
/*     */   }
/*     */   
/*     */   public static List<Integer> getStashIDs(StashIDItemSetCombination combo, CriteriaCombination.Soulbound soulbound, CriteriaCombination.SC_HC schc, boolean isHardcore, String charName) {
/* 366 */     List<Integer> listAll = new LinkedList<>();
/*     */     
/* 368 */     try (Connection conn = GDDBData.getConnection()) {
/* 369 */       List<CriteriaCombination> combos = combo.createLevel1Combinations(combo);
/*     */       
/* 371 */       for (CriteriaCombination cc : combos) {
/* 372 */         String command1 = cc.determineLevel1Statement(soulbound, schc, isHardcore, charName);
/*     */         
/* 374 */         if ((cc.getCriteria()).statInfos.isEmpty()) {
/* 375 */           try (PreparedStatement ps = conn.prepareStatement(command1)) {
/*     */             try {
/* 377 */               cc.addSingleIntCombo(listAll, ps, command1, null);
/*     */             }
...
/* 384 */             Object[] args = { command1 };
/* 385 */             String msg = GDMsgFormatter.format(GDMsgFormatter.rbMsg, "ERR_PREPARE_FAILED", args);
/*     */             
/* 387 */             GDMsgLogger.addError(msg);
/*     */           } 
/*     */           
/* 390 */           conn.commit(); continue;
/*     */         } 
/* 392 */         for (SelectionCriteria.StatInfo info : (cc.getCriteria()).statInfos) {
/* 393 */           String command2 = cc.determineLevel2Statement(command1, info);
/*     */           
/* 395 */           for (String statType : info.statTypes) {
/* 396 */             try (PreparedStatement ps = conn.prepareStatement(command2)) {
/*     */               try {
/* 398 */                 cc.addSingleIntCombo(listAll, ps, command2, statType);
/*     */               }
...
/* 405 */               Object[] args = { command2 };
/* 406 */               String msg = GDMsgFormatter.format(GDMsgFormatter.rbMsg, "ERR_PREPARE_FAILED", args);
/*     */               
/* 408 */               GDMsgLogger.addError(msg);
/*     */             } 
/*     */             
/* 411 */             conn.commit();
/*     */           }
...
/* 418 */       GDMsgLogger.addError(GDMsgFormatter.getString(GDMsgFormatter.rbMsg, "ERR_DB_CONN_FAILED"));
/*     */     } 
/*     */     
/* 421 */     return listAll;
/*     */   }
...
/* Location:              C:\Users\sammiler\Downloads\GDStash_v174\GDStash.jar!\org\gdstash\db\criteria\StashIDItemSetCombination.class
